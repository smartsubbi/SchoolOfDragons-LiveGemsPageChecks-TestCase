...
public class TestCase23
{
	...
	ExtentTest logger;		
	String Category;
	String testCase23Result = "No result";
	...
	{
		logger = report.startTest("Test Case 23 : Live - Verify Gems page - Fourth Gems option ("+GemsPage.fourthGemsAmount1+") Verify Select Payment DB and PayPal Payment form","This test case will verify Fourth Gems option ("+GemsPage.fourthGemsAmount1+") Select Payment DB and PayPal Payment form");		
		...
		gemsPage.verifyFourthGemsOptionSelectPaymentMethodDBandPaymentFormPayPal(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase23Result = "Fail";
		}	
		testCase23Result = "Pass";		
	}
