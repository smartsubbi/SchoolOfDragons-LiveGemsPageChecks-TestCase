...
public class TestCase6
{
	...
	ExtentTest logger;		
	String Category;
	static String testCase6Result = "No result";
	...
	{
		logger = report.startTest("Test Case 6 : Live - Verify Gems page - Fifth Gems option ("+GemsPage.fifthGemsAmount1+") Verify Select Payment DB and Visa Payment form","This test case will verify Fifth Gems option ("+GemsPage.fifthGemsAmount1+") Select Payment DB and Visa Payment form");		
		...
		gemsPage.verifyFifthGemsOptionSelectPaymentMethodDBandPaymentFormVisa(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase6Result = "Fail";
		}
		testCase6Result = "Pass";
	}
