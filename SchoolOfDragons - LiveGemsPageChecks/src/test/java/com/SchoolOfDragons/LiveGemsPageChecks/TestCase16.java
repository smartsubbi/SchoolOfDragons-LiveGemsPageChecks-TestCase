...
public class TestCase16
{
	...
	ExtentTest logger;		
	String Category;
	static String testCase16Result = "No result";
	...
	{
		logger = report.startTest("Test Case 16 : Live - Verify Gems page - Third Gems option ("+GemsPage.thirdGemsAmount1+") Verify Select Payment DB and MolPoints Payment form","This test case will verify Third Gems option ("+GemsPage.thirdGemsAmount1+") Select Payment DB and MolPoints Payment form");		
		...
		gemsPage.verifyThirdGemsOptionSelectPaymentMethodDBandPaymentFormMolPoints(logger);
