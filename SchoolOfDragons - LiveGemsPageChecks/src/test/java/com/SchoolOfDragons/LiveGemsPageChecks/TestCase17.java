...
public class TestCase17
{
	...
	ExtentTest logger;		
	String Category;
	static String testCase17Result = "No result";
	...
	{
		logger = report.startTest("Test Case 17 : Live - Verify Gems page - Fourth Gems option ("+GemsPage.fourthGemsAmount1+") Verify Select Payment DB and MolPoints Payment form","This test case will verify Fourth Gems option ("+GemsPage.fourthGemsAmount1+") Select Payment DB and MolPoints Payment form");		
		...
		gemsPage.verifyFourthGemsOptionSelectPaymentMethodDBandPaymentFormMolPoints(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase17Result = "Fail";
		}	
		testCase17Result = "Pass";		
	}
