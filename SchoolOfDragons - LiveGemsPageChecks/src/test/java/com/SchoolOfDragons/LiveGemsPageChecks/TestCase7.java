...
public class TestCase7
{
	...
	ExtentTest logger;		
	String Category;
	static String testCase7Result = "No result";
	...
	{
		logger = report.startTest("Test Case 7 : Live - Verify Gems page - Sixth Gems option ("+GemsPage.sixthGemsAmount1+") Verify Select Payment DB and Visa Payment form","This test case will verify sixth Gems option ("+GemsPage.sixthGemsAmount1+") Select Payment DB and Visa Payment form");		
		...
		gemsPage.verifySixthGemsOptionSelectPaymentMethodDBandPaymentFormVisa(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase7Result = "Fail";
		}		
		testCase7Result = "Pass";
	}
