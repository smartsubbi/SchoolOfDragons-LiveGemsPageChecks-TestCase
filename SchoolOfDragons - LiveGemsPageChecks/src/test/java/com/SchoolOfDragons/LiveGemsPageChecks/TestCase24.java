...
public class TestCase24
{
	...
	ExtentTest logger;		
	String Category;
	String TestCase24Result = "No result";
	...
	{
		logger = report.startTest("Test Case 24 : Live - Verify Gems page - Fifth Gems option ("+GemsPage.fifthGemsAmount1+") Verify Select Payment DB and PayPal Payment form","This test case will verify Fifth Gems option ("+GemsPage.fifthGemsAmount1+") Select Payment DB and PayPal Payment form");		
		...
		gemsPage.verifyFifthGemsOptionSelectPaymentMethodDBandPaymentFormPayPal(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			TestCase24Result = "Fail";
		}
		TestCase24Result = "Pass";
	}
