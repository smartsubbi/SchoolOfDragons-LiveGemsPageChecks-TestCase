...
public class TestCase5
{
	...
	ExtentTest logger;		
	String Category;
	static String testCase5Result = "No result";
	...
	{
		logger = report.startTest("Test Case 5 : Live - Verify Gems page - Fourth Gems option ("+GemsPage.fourthGemsAmount1+") Verify Select Payment DB and Visa Payment form","This test case will verify Fourth Gems option ("+GemsPage.fourthGemsAmount1+") Select Payment DB and Visa Payment form");		
		...
		gemsPage.verifyFourthGemsOptionSelectPaymentMethodDBandPaymentFormVisa(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase5Result = "Fail";
		}	
		testCase5Result = "Pass";		
	}
