...
public class TestCase8
{
	...
	{
		logger = report.startTest("Test Case 8 : Live - Verify Gems page - First Gems option ("+GemsPage.firstGemsAmount1+") Verify Select Payment DB and MasterCard Payment form","This test case will verify First Gems option ("+GemsPage.firstGemsAmount1+") Select Payment DB and MasterCard Payment form");		
		...
		gemsPage.verifyFirstGemsOptionSelectPaymentMethodDBandPaymentFormMasterCard(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase8Result = "Fail";
		}			
		testCase8Result = "Pass";
	}
