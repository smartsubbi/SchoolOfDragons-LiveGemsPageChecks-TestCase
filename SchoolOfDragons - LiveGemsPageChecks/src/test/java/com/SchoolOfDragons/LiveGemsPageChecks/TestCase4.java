...
public class TestCase4
{
	...
	{
		logger = report.startTest("Test Case 4 : Live - Verify Gems page - Third Gems option ("+GemsPage.thirdGemsAmount1+") Verify Select Payment DB and Visa Payment form","This test case will verify Third Gems option ("+GemsPage.thirdGemsAmount1+") Select Payment DB and Visa Payment form");		
		...
		gemsPage.verifyThirdGemsOptionSelectPaymentMethodDBandPaymentFormVisa(logger);
