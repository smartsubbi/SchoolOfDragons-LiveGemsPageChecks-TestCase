...
public class TestCase13
{
	...
	ExtentTest logger;		
	String Category;
	static String testCase13Result = "No result";
	...
	{
		logger = report.startTest("Test Case 13 : Live - Verify Gems page - Sixth Gems option ("+GemsPage.sixthGemsAmount1+") Verify Select Payment DB and MasterCard Payment form","This test case will verify sixth Gems option ("+GemsPage.sixthGemsAmount1+") Select Payment DB and MasterCard Payment form");		
		...
		gemsPage.verifySixthGemsOptionSelectPaymentMethodDBandPaymentFormMasterCard(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase13Result = "Fail";
		}		
		testCase13Result = "Pass";
	}
