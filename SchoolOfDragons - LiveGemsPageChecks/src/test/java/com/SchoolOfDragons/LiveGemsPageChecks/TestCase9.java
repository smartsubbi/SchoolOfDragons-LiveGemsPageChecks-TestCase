...
public class TestCase9
{
	...
	ExtentTest logger;		
	String Category;
	String testCase9Result = "No result";
	...
	{
		logger = report.startTest("Test Case 9 : Live - Verify Gems page - Second Gems option ("+GemsPage.secondGemsAmount1+") Verify Select Payment DB and MasterCard Payment form","This test case will verify Second Gems option ("+GemsPage.secondGemsAmount1+") Select Payment DB and MasterCard Payment form");		
		...
		gemsPage.verifySecondGemsOptionSelectPaymentMethodDBandPaymentFormMasterCard(logger);
