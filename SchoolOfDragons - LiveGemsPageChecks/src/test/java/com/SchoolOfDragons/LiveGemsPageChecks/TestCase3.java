...
public class TestCase3
{
	...
	{
		logger = report.startTest("Test Case 3 : Live - Verify Gems page - Second Gems option ("+GemsPage.secondGemsAmount1+") Verify Select Payment DB and Visa Payment form","This test case will verify Second Gems option ("+GemsPage.secondGemsAmount1+") Select Payment DB and Visa Payment form");		
		...
		gemsPage.verifySecondGemsOptionSelectPaymentMethodDBandPaymentFormVisa(logger);
