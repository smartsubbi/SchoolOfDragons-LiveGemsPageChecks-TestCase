...
public class TestCase18
{
	...
	ExtentTest logger;		
	String Category;
	static String testCase18Result = "No result";
	...
	{
		logger = report.startTest("Test Case 18 : Live - Verify Gems page - Fifth Gems option ("+GemsPage.fifthGemsAmount1+") Verify Select Payment DB and MolPoints Payment form","This test case will verify Fifth Gems option ("+GemsPage.fifthGemsAmount1+") Select Payment DB and MolPoints Payment form");		
		...
		gemsPage.verifyFifthGemsOptionSelectPaymentMethodDBandPaymentFormMolPoints(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase18Result = "Fail";
		}
		testCase18Result = "Pass";
	}
