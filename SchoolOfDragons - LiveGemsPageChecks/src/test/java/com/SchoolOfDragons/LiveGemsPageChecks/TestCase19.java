...
public class TestCase19
{
	...
	ExtentTest logger;		
	String Category;
	static String testCase19Result = "No result";
	...
	{
		logger = report.startTest("Test Case 19 : Live - Verify Gems page - Sixth Gems option ("+GemsPage.sixthGemsAmount1+") Verify Select Payment DB and MolPoints Payment form","This test case will verify sixth Gems option ("+GemsPage.sixthGemsAmount1+") Select Payment DB and MolPoints Payment form");		
		...
		gemsPage.verifySixthGemsOptionSelectPaymentMethodDBandPaymentFormMolPoints(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase19Result = "Fail";
		}		
		testCase19Result = "Pass";
	}
