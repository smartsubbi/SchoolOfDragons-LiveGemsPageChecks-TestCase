...
public class TestCase12
{
	...
	ExtentTest logger;		
	String Category;
	String testCase12Result = "No result";
	...
	{
		logger = report.startTest("Test Case 12 : Live - Verify Gems page - Fifth Gems option ("+GemsPage.fifthGemsAmount1+") Verify Select Payment DB and MasterCard Payment form","This test case will verify Fifth Gems option ("+GemsPage.fifthGemsAmount1+") Select Payment DB and MasterCard Payment form");		
		...
		gemsPage.verifyFifthGemsOptionSelectPaymentMethodDBandPaymentFormMasterCard(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase12Result = "Fail";
		}
		testCase12Result = "Pass";
	}
