...
public class TestCase22
{
	...
	ExtentTest logger;		
	String Category;
	String testCase22Result = "No result";
	...
	{
		logger = report.startTest("Test Case 22 : Live - Verify Gems page - Third Gems option ("+GemsPage.thirdGemsAmount1+") Verify Select Payment DB and PayPal Payment form","This test case will verify Third Gems option ("+GemsPage.thirdGemsAmount1+") Select Payment DB and PayPal Payment form");		
		...
		gemsPage.verifyThirdGemsOptionSelectPaymentMethodDBandPaymentFormPayPal(logger);
