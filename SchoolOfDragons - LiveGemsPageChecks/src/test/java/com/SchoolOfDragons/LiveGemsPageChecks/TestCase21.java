...
public class TestCase21
{
	...
	ExtentTest logger;		
	String Category;
	String testCase21Result = "No result";
	...
	{
		logger = report.startTest("Test Case 21 : Live - Verify Gems page - Second Gems option ("+GemsPage.secondGemsAmount1+") Verify Select Payment DB and PayPal Payment form","This test case will verify Second Gems option ("+GemsPage.secondGemsAmount1+") Select Payment DB and PayPal Payment form");		
		...
		gemsPage.verifySecondGemsOptionSelectPaymentMethodDBandPaymentFormPayPal(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase21Result = "Fail";
		}		
		testCase21Result = "Pass";
	}
