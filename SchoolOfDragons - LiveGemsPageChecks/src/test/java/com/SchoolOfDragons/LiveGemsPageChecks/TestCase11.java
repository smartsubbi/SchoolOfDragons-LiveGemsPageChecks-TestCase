...
public class TestCase11
{
	...
	{
		logger = report.startTest("Test Case 11 : Live - Verify Gems page - Fourth Gems option ("+GemsPage.fourthGemsAmount1+") Verify Select Payment DB and MasterCard Payment form","This test case will verify Fourth Gems option ("+GemsPage.fourthGemsAmount1+") Select Payment DB and MasterCard Payment form");		
		...
		gemsPage.verifyFourthGemsOptionSelectPaymentMethodDBandPaymentFormMasterCard(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase11Result = "Fail";
		}	
		testCase11Result = "Pass";		
	}
