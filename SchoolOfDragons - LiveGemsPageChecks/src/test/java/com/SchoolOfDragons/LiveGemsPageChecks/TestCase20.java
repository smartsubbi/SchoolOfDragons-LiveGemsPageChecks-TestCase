...
public class TestCase20
{
	...
	ExtentTest logger;		
	String Category;
	String testCase20Result = "No result";
	...
	{
		logger = report.startTest("Test Case 20 : Live - Verify Gems page - First Gems option ("+GemsPage.firstGemsAmount1+") Verify Select Payment DB and PayPal Payment form","This test case will verify First Gems option ("+GemsPage.firstGemsAmount1+") Select Payment DB and PayPal Payment form");		
		...
		gemsPage.verifyFirstGemsOptionSelectPaymentMethodDBandPaymentFormPayPal(logger);
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase20Result = "Fail";
		}			
		testCase20Result = "Pass";
	}
